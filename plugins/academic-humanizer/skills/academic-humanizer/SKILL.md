...
description: Improve the clarity and voice of AI-assisted academic writing (papers, theses, rebuttals) and funding proposals while preserving scholarly conventions, matching claims to evidence, and matching the author's own voice. It never changes a number, result, equation, or citation, and it is not for evading AI-use disclosure.
---
